import type { DocenteBasicInfo, EstudianteBasicInfo, PaginatedResponse, UserBasicInfo, RoleInfo, Phase, Gestion, TypeDoc, SpecialityInfo, ResearchLine, Semester, ProjectResponseDto, CreateProjectDto, AdmEntrega, EntregaDetalle, StudentDocumentsResponse, Pagination, Defensa, FilesByTypeResponse, DocumentTypeSummaryResponse, } from "./types";
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "";
const resolveApiUrl = (path: string) => path.startsWith("http://") || path.startsWith("https://") ? path : `${API_BASE_URL}${path}`;
...
export const apiClient = {
    ...
    auth: {
        ...
        refresh: async () => apiClient.request<{
            access_token: string;
        }>("/auth/refresh", {
            method: "POST",
            skipAuth: true,
        ...
        logoutAll: async () => apiClient.request("/auth/logout-all", {
            method: "POST",
        }),
        logoutSession: async (sessionId: string) => apiClient.request(`/auth/sessions/${sessionId}`, {
            method: "POST",
        }),
        me: async () => apiClient.request("/auth/me", {}),
        forgotPassword: async (email: string) => apiClient.request("/auth/forgot-password", {
            method: "POST",
            body: JSON.stringify({ email }),
            skipAuth: true,
        }),
        resetPassword: async (token: string, newPassword: string) => apiClient.request("/auth/reset-password", {
            method: "POST",
    ...
    profile: {
        ...
        updatePassword: async (currentPassword: string, newPassword: string) => apiClient.request("/profile/password", {
            method: "PATCH",
            body: JSON.stringify({ currentPassword, newPassword }),
        }),
        updateSemester: async (semestreId: number) => apiClient.request<{
            message: string;
            data?: Semester | null;
        }>("/profile/semestre", {
            method: "PATCH",
        ...
        updateGestion: async (typeGestion: "I" | "II") => apiClient.request<{
            message: string;
            data?: "I" | "II" | null;
        }>("/profile/gestion", {
            method: "PATCH",
        ...
        fetchImage: async (path = "/profile/image"): Promise<Blob | null> => {
            const token = apiClient.getAccessToken();
            if (!token)
                throw new Error("No hay una sesión activa para obtener la imagen de perfil");
    ...
    students: {
        list: async (params?: {
            ...
            if (params?.especialidad)
                query.append("especialidad", params.especialidad);
            if (params?.idSaga)
                query.append("idSaga", params.idSaga.toString());
            if (params?.idEspecialidad)
                query.append("idEspecialidad", params.idEspecialidad.toString());
            if (params?.idSemestre)
                query.append("idSemestre", params.idSemestre.toString());
            if (params?.idGestion)
                query.append("idGestion", params.idGestion.toString());
            if (params?.ci)
                query.append("ci", params.ci);
    ...
    users: {
        ...
        resetPassword: async (id: string) => apiClient.request<{
            ok: boolean;
            message?: string;
        }>(`/users/${id}/reset-password`, {
            method: "POST",
        }),
        assignRole: async (id: string, roleId: number) => apiClient.request(`/users/${id}/roles`, {
            method: "POST",
            body: JSON.stringify({ roleId }),
        }),
        removeRole: async (id: string, roleId: number) => apiClient.request<{
            message: string;
    ...
    projects: {
        ...
        getByStudent: async (studentId: string | number) => apiClient.request<ProjectResponseDto[]>(`/projects/student/${studentId}`, {}),
        getTemario: async (id: string | number) => apiClient.request<{
        ...
        updateTemario: async (id: number, data: {
            capitulos: {
                titulo: string;
                subcapitulos?: {
                    titulo: string;
        ...
        create: async (data: CreateProjectDto) => apiClient.request<{
            message: string;
        ...
        update: async (id: number, data: Partial<CreateProjectDto> & {
            isActive?: boolean;
        }) => apiClient.request<{
            message: string;
            data: ProjectResponseDto;
        ...
        delete: async (id: number) => apiClient.request<{
            message: string;
        }>(`/projects/${id}`, {
            method: "DELETE",
        }),
    ...
    researchLines: {
        ...
        getByArea: async (areaId: number) => apiClient.request<{
            data: ResearchLine[];
            total: number;
        }>(`/lineas-investigacion/area/${areaId}`, {}),
        create: async (data: {
            name: string;
    ...
    researchAreas: {
        ...
        create: async (name: string) => apiClient.request<{
            message: string;
            data: any;
        }>("/areas-investigacion", {
            method: "POST",
        ...
        update: async (id: number, name: string) => apiClient.request<{
            message: string;
            data: any;
        }>(`/areas-investigacion/${id}`, {
            method: "PATCH",
            body: JSON.stringify({ name }),
        }),
        delete: async (id: number) => apiClient.request<{
    ...
    roles: {
        ...
        updateStatus: async (id: number, isActive: boolean) => apiClient.request<{
            message: string;
        }>(`/roles/${id}/status`, {
            method: "PATCH",
    ...
    defensas: {
        list: async (params?: {
            ...
            if (params?.search)
                query.append("search", params.search);
            if (params?.idFase)
                query.append("idFase", params.idFase.toString());
    ...
    specialities: {
        list: async (params?: {
            ...
            if (params?.search)
                query.append("search", params.search);
            if (params?.nivelAcad)
                query.append("nivelAcad", params.nivelAcad);
            if (params?.sortBy)
                query.append("sortBy", params.sortBy);
            if (params?.sortOrder)
                query.append("sortOrder", params.sortOrder);
    ...
    admEntregas: {
        ...
        filter: async (params: {
            ...
            const query = new URLSearchParams();
            if (params.idDocente)
                query.append("idDocente", params.idDocente.toString());
            if (params.idGestion)
                query.append("idGestion", params.idGestion.toString());
            if (params.idSemestre)
                query.append("idSemestre", params.idSemestre.toString());
            ...
            return apiClient.request<{
                ok: boolean;
                data: AdmEntrega[];
            }>(`/adm-entregas/filtros?${query.toString()}`, {});
        },
        get: async (id: number) => apiClient.request<{
            ok: boolean;
            data: AdmEntrega;
        }>(`/adm-entregas/${id}`, {}),
        create: async (data: Omit<AdmEntrega, "id" | "createdAt" | "_count" | "estudiantes"> & {
            estudiantes: number[];
        }) => apiClient.request<{
            ok: boolean;
            message: string;
        ...
        update: async (id: number, data: Partial<AdmEntrega>) => apiClient.request<{
            ok: boolean;
            message: string;
            data: AdmEntrega;
        }>(`/adm-entregas/${id}`, {
        ...
        assignStudents: async (id: number, estudiantes: number[]) => apiClient.request<{
            ok: boolean;
            message: string;
        }>(`/adm-entregas/${id}/estudiantes`, {
            method: "POST",
            body: JSON.stringify({ estudiantes }),
        }),
        unassignStudent: async (idAdmEntrega: number, idEstudiante: number) => apiClient.request<{
            ok: boolean;
            message: string;
    ...
    entregas: {
        ...
        getMySchedules: async () => apiClient.request<{
            ok: boolean;
            data: AdmEntrega[];
        }>("/entregas/mis-cronogramas", {}),
        getMyDeliveries: async () => apiClient.request<{
            ok: boolean;
            data: EntregaDetalle[];
        }>("/entregas/mis-entregas", {}),
        getMySubmission: async (idAdmEntrega: number) => apiClient.request<{
            ok: boolean;
            data: EntregaDetalle;
        }>(`/entregas/mis-entregas/${idAdmEntrega}`, {}),
        getMyEntrega: async (idAdmEntrega: number) => apiClient.request<{
            ok: boolean;
            data: EntregaDetalle;
        }>(`/entregas/mis-entregas/${idAdmEntrega}`, {}),
        getPending: async () => apiClient.request<{
            ok: boolean;
            data: EntregaDetalle[];
        }>("/entregas/pendientes", {}),
        getBySchedule: async (idAdmEntrega: number) => apiClient.request<{
            ok: boolean;
            data: EntregaDetalle[];
        }>(`/entregas/cronograma/${idAdmEntrega}`, {}),
        ...
        downloadRevision: async (id: number, type: "docTG" | "docTutor" | "docRev1" | "docRev2") => {
            const token = apiClient.getAccessToken();
    ...
    reportes: {
        ...
        cartaAceptacionTutor: async (data: {
            idProyecto: number;
            cite?: string;
            fecha?: string;
        }) => apiClient.request<{
        ...
        memoAsignacionTutor: async (data: {
            idProyecto: number;
            cite: string;
            ciudad: string;
            fecha: string;
    ...
    documents: {
        getByStudent: async (idEstudiante: number) => apiClient.request<{
            ok: boolean;
            message: string;
            data: StudentDocumentsResponse;
        }>(`/documents/student/${idEstudiante}`, {}),
        getByProject: async (idProyecto: number) => apiClient.request<any>(`/documents/project/${idProyecto}`, {}),
        getTypesSummary: async () => apiClient.request<{
            ok: boolean;
            message: string;
            data: DocumentTypeSummaryResponse;
        }>("/documents/types/summary", {}),
        getFilesByType: async (idTypeDoc: number) => apiClient.request<{
            ok: boolean;
            message: string;
            data: FilesByTypeResponse;
