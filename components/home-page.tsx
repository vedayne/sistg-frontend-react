...
export default function HomePage() {
    ...
    return (<div className="min-h-screen bg-background">
            ...
            <Card className="border-2 border-primary/20 hover:shadow-lg transition-shadow">
              ...
              <CardContent className="text-center">
                <a href="https://repositoriogrado.net.emi.edu.bo/#/" target="_blank" rel="noopener noreferrer">
                  <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-white bg-transparent dark:text-white">
                    Ir al Repositorio
                  </Button>
                </a>
              </CardContent>
      ...
      <section className="py-16 bg-background" id="contacto">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {unidadesAcademicas.map((unidad) => (<Card key={unidad.id} className="border-l-4 border-l-primary hover:shadow-lg transition-shadow">
                <CardHeader>
      ...
      {showScrollButton && (<button onClick={scrollToTop} className="fixed bottom-6 right-6 bg-primary hover:bg-primary/90 text-white rounded-full p-3 shadow-lg transition-all duration-300 z-40" aria-label="Scroll to top">
