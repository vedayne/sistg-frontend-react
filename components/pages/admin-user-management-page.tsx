      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleResetPassword} className="flex-1 bg-primary hover:bg-primary/90" disabled={isLoading}>
              {isLoading ? (<>
...
export default function AdminUserManagementPage() {
    ...
    return (<div className="p-6 space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <Input placeholder="Buscar por nombre..." value={searchTerm} onChange={(e) => {
            ...
            <div>
              ...
              <Input placeholder="Buscar por email..." value={searchEmail} onChange={(e) => {
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <select className="border rounded-md px-3 py-2 bg-background text-sm" value={limit} onChange={(e) => {
        ...
        <CardContent className="pt-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {filteredUsuarios.length > 0 ? (filteredUsuarios.map((usuario, index) => (<tr key={usuario.id} className="border-b hover:bg-secondary/50 dark:hover:bg-primary/5 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <Button size="sm" onClick={() => setSelectedUsuario(usuario)} className="bg-cyan-600 hover:bg-cyan-700 text-white text-xs">
                          DETALLES
                        </Button>
                      </td>
                    </tr>))) : (<tr>
          ...
          <div className="flex items-center justify-between mt-6 text-sm text-muted-foreground">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="sm" onClick={() => setPage((prev) => prev + 1)} disabled={pagination ? !pagination.hasNextPage : filteredUsuarios.length < limit}>
                Siguiente
              </Button>
            </div>
          </div>
      ...
      <Dialog open={!!selectedUsuario} onOpenChange={() => setSelectedUsuario(null)}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <button onClick={() => setSelectedUsuario(null)} className="absolute right-4 top-4 text-muted-foreground hover:text-foreground">
              <X className="w-5 h-5"/>
            </button>
          </DialogHeader>
          {selectedUsuario && (<div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Badge variant="outline" className={`mt-2 ${STATUS_MAP[selectedUsuario.status]?.color || "bg-gray-100"}`}>
              ...
              <div className="space-y-3">
                ...
                {selectedUsuario.especialidad && (<div>
              ...
              <div className="flex flex-col gap-2 pt-4 border-t">
                <Button onClick={() => setShowPasswordReset(true)} className="w-full bg-primary hover:bg-primary/90 text-white flex gap-2">
      ...
      <PasswordResetModal isOpen={showPasswordReset} onClose={() => setShowPasswordReset(false)} user={selectedUsuario} onSuccess={() => {
