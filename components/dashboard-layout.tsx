      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="border-b bg-card/90 backdrop-blur supports-[backdrop-filter]:bg-card/80 sticky top-0 z-40">
          <div className="px-6 py-4 flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-foreground">RTG EMI</h1>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button size="sm" variant="outline" onClick={handleLogout} className="flex gap-2 items-center bg-transparent">
